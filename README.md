...
Планируется добавить настройки, как минимум версии docker-compose, под которую собирается файл. Изменить перенос сревиса из всех в выбранные. Добавить удаление сервиса. Сделать добавление собственного сервиса. Изменение его название. Добавление не  существующих на данный момент в списке всех сервисов сервисов из Docker Hub.
